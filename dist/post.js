...
.post-controls-preview {
    display: flex;
    gap: 15px;
    align-items: center;
}

.post-controls-preview button,
.edit-button,
...
.publish button,
.edit-button.unpublished {
    background-color: rgb(252, 211, 225);
}

.publish button:hover,
.edit-button.unpublished:hover {
    background-color: rgb(252, 196, 213);
}
...
.post-controls-preview .delete-button {
    padding: 2px 6px;
}
...
}`, "",{"version":3,"sources":["webpack://./src/styles/index.css"],"names":[],"mappings":"AAAA;IACI,SAAS;IACT,UAAU;IACV,4CAA4C;AAChD;;AAEA;IACI,aAAa;IACb,sBAAsB;IACtB,aAAa;AACjB;;AAEA;;IAEI,YAAY;IACZ,kCAAkC;IAClC,+BAA+B;AACnC;;AAEA;IACI,aAAa;IACb,SAAS;IACT,mBAAmB;AACvB;;AAEA;IACI,kBAAkB;AACtB;;AAEA;IACI,YAAY;IACZ,qBAAqB;AACzB;;AAEA;IACI,cAAc;IACd,WAAW;AACf;;AAEA;IACI,YAAY;AAChB;;AAEA;IACI,cAAc;IACd,WAAW;AACf;;AAEA;IACI,OAAO;IACP,aAAa;AACjB;;AAEA;IACI,eAAe;AACnB;;AAEA;IACI,kBAAkB;AACtB;;AAEA;IACI,aAAa;IACb,sBAAsB;IACtB,SAAS;IACT,kBAAkB;AACtB;;AAEA;IACI,aAAa;IACb,8BAA8B;IAC9B,SAAS;IACT,YAAY;AAChB;;AAEA;IACI,+BAA+B;AACnC;;AAEA;IACI,0BAA0B;AAC9B;;AAEA;IACI,aAAa;IACb,sBAAsB;IACtB,QAAQ;IACR,uBAAuB;AAC3B;;AAEA;IACI,kBAAkB;AACtB;;AAEA;IACI,aAAa;IACb,SAAS;IACT,mBAAmB;AACvB;;AAEA;;;;IAII,YAAY;IACZ,kBAAkB;IAClB,iBAAiB;IACjB,eAAe;AACnB;;AAEA;;IAEI,oCAAoC;AACxC;;AAEA;;IAEI,oCAAoC;AACxC;;AAEA;;;IAGI,oCAAoC;AACxC;;AAEA;;;IAGI,oCAAoC;AACxC;;AAEA;IACI,kBAAkB;IAClB,iBAAiB;IACjB,qBAAqB;IACrB,YAAY;IACZ,iBAAiB;AACrB;;AAEA;IACI,gBAAgB;AACpB;;AAEA;IACI,cAAc;IACd,WAAW;AACf;;AAEA;IACI,cAAc;IACd,WAAW;AACf;;AAEA;IACI,kBAAkB;IAClB,YAAY;AAChB;;AAEA;IACI,YAAY;AAChB;;AAEA;IACI;QACI,kBAAkB;IACtB;;IAEA;QACI,SAAS;IACb;;IAEA;QACI,SAAS;IACb;AACJ;;AAEA;IACI;QACI,iBAAiB;IACrB;;IAEA;QACI,sBAAsB;QACtB,QAAQ;IACZ;AACJ","sourcesContent":["* {\n    margin: 0;\n    padding: 0;\n    font-family: 'Times New Roman', Times, serif;\n}\n\nbody {\n    display: flex;\n    flex-direction: column;\n    height: 100vh;\n}\n\nheader,\nfooter {\n    padding: 8px;\n    background-color: rgb(76, 76, 167);\n    background-color: rebeccapurple;\n}\n\nheader {\n    display: flex;\n    gap: 10px;\n    align-items: center;\n}\n\nh1 {\n    margin-right: auto;\n}\n\nh1 a {\n    color: white;\n    text-decoration: none;\n}\n\n.profile {\n    height: 2.5rem;\n    width: auto;\n}\n\nh3 {\n    color: white;\n}\n\n.log-out {\n    height: 1.8rem;\n    width: auto;\n}\n\nmain {\n    flex: 1;\n    padding: 10px;\n}\n\nbutton:hover {\n    cursor: pointer;\n}\n\nh2 {\n    text-align: center;\n}\n\n.posts-container {\n    display: flex;\n    flex-direction: column;\n    gap: 20px;\n    padding: 10px 50px;\n}\n\n.post-container-preview {\n    display: flex;\n    justify-content: space-between;\n    gap: 10px;\n    padding: 5px;\n}\n\n.publish {\n    background-color: lavenderblush;\n}\n\n.unpublish {\n    background-color: lavender;\n}\n\n.post-info-preview {\n    display: flex;\n    flex-direction: column;\n    gap: 3px;\n    align-items: flex-start;\n}\n\nh4 {\n    font-size: 1.15rem;\n}\n\n.post-controls-preview {\n    display: flex;\n    gap: 15px;\n    align-items: center;\n}\n\n.post-controls-preview button,\n.edit-button,\n.delete-comment-button,\n.add-button {\n    border: none;\n    border-radius: 4px;\n    padding: 4px 10px;\n    font-size: 1rem;\n}\n\n.publish button,\n.edit-button.unpublished {\n    background-color: rgb(252, 211, 225);\n}\n\n.publish button:hover,\n.edit-button.unpublished:hover {\n    background-color: rgb(252, 196, 213);\n}\n\n.unpublish button,\n.edit-button.published,\n.add-button {\n    background-color: rgb(204, 204, 253);\n}\n\n.unpublish button:hover,\n.edit-button.published:hover,\n.add-button:hover {\n    background-color: rgb(192, 192, 252);\n}\n\n.add-button {\n    align-self: center;\n    padding: 3px 15px;\n    text-decoration: none;\n    color: black;\n    font-size: 1.2rem;\n}\n\n.post-controls-preview .delete-button {\n    padding: 2px 6px;\n}\n\n.edit {\n    height: 1.5rem;\n    width: auto;\n}\n\n.delete {\n    height: 1.4rem;\n    width: auto;\n}\n\nfooter p {\n    text-align: center;\n    color: white;\n}\n\nfooter a {\n    color: white;\n}\n\n@media (max-width: 750px) {\n    .posts-container {\n        padding: 10px 15px;\n    }\n\n    .post-container-preview {\n        gap: 10px;\n    }\n\n    .post-controls-preview {\n        gap: 10px;\n    }\n}\n\n@media (max-width: 500px) {\n    .posts-container {\n        padding: 10px 5px;\n    }\n\n    .post-container-preview {\n        flex-direction: column;\n        gap: 3px;\n    }\n}"],"sourceRoot":""}]);
// Exports
...
}`, "",{"version":3,"sources":["webpack://./src/styles/post.css"],"names":[],"mappings":"AAAA;IACI,gCAAgC;IAChC,aAAa;IACb,sBAAsB;IACtB,SAAS;IACT,aAAa;IACb,mBAAmB;AACvB;;AAEA;;IAEI,oBAAoB;IACpB,kBAAkB;AACtB;;AAEA;IACI,kBAAkB;IAClB,iBAAiB;IACjB,qBAAqB;IACrB,YAAY;AAChB;;AAEA;IACI,iBAAiB;IACjB,mBAAmB;AACvB;;AAEA;IACI,SAAS;IACT,0BAA0B;IAC1B,mBAAmB;IACnB,aAAa;AACjB;;AAEA;IACI,aAAa;IACb,8BAA8B;IAC9B,mBAAmB;AACvB;;AAEA;IACI,oCAAoC;IACpC,kBAAkB;AACtB;;AAEA;IACI,oCAAoC;AACxC;;AAEA;IACI,kBAAkB;AACtB;;AAEA;IACI,kBAAkB;AACtB;;AAEA;IACI;QACI,aAAa;IACjB;AACJ","sourcesContent":[".post-container {\n    /* background-color: lavender; */\n    display: flex;\n    flex-direction: column;\n    gap: 10px;\n    padding: 10px;\n    margin-bottom: 10px;\n}\n\n.post-date,\n.post-status {\n    align-self: flex-end;\n    font-style: italic;\n}\n\n.edit-button {\n    align-self: center;\n    padding: 3px 15px;\n    text-decoration: none;\n    color: black;\n}\n\nh4 {\n    font-size: 1.3rem;\n    margin-bottom: 10px;\n}\n\n.comment {\n    gap: 10px;\n    background-color: honeydew;\n    margin-bottom: 15px;\n    padding: 10px;\n}\n\n.comment-header {\n    display: flex;\n    justify-content: space-between;\n    margin-bottom: 10px;\n}\n\n.delete-comment-button {\n    background-color: rgb(199, 255, 199);\n    align-self: center;\n}\n\n.delete-comment-button:hover {\n    background-color: rgb(176, 255, 176);\n}\n\nh5 {\n    font-size: 1.15rem;\n}\n\n.comment-date {\n    font-style: italic;\n}\n\n@media (min-width: 350px) {\n    main {\n        padding: 20px;\n    }\n}"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
function displayPost(response) {
    ...
    postDate.textContent = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(post.timestamp), "PPPp");
    ...
    if (allCommentsToAPost.length) {
        allCommentsToAPost.forEach(comment => {
            ...
            commentDate.textContent = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(comment.timestamp), "PPPp");
            ...
            deleteSVG.setAttribute("src", _images_delete_svg__WEBPACK_IMPORTED_MODULE_2__);
